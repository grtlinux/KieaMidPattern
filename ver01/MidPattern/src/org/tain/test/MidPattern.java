...
public class MidPattern {
	...
	private static void setVariables() throws Exception {
		...
		if (flag) {
			...
			if ((param = ArgsUtils.getValue("-basedir", 0)) != null) {
				baseDir = param;
			}

			if ((param = ArgsUtils.getValue("-datafile", 0)) != null) {
				dataFile = param;
			}
		}
		...
		if (flag) {
			...
			if ((param = ArgsUtils.getValue("-range", 0)) != null) {
				begIdx = Integer.parseInt(param) - 1;
			}

			if ((param = ArgsUtils.getValue("-range", 1)) != null) {
		...
		if (flag) {
			...
			if (ArgsUtils.getValues("-shuffle") != null) {
				runShuffle = true;
			}
		}
		...
		if (flag) {
			...
			if (ArgsUtils.getValues("-auto") != null) {
				runAuto = true;

				if ((param = ArgsUtils.getValue("-auto", 0)) != null) {
			...
			if (ArgsUtils.getValues("-exam") != null) {
				runExam = true;

				if ((param = ArgsUtils.getValue("-exam", 0)) != null) {
